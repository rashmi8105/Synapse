...
class BucketDetailValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testCheckOverlap()
    {
        ...
        $this->specify("Checking that the check overlap function is checking risk variable buckets correctly", function ($throwsException, $minBucket1, $minBucket2, $maxBucket1, $maxBucket2, $expectedResult) {
            ...
            $bucketDetailValidator = new BucketDetailValidator();

            try{
                $isRiskVariableValid = $bucketDetailValidator->checkOverlap($minBucket1, $minBucket2, $maxBucket1, $maxBucket2);
