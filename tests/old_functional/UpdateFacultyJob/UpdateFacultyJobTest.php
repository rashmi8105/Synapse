...
use Synapse\UploadBundle\Job\UpdateFaculty;
use Synapse\CoreBundle\Entity\MetadataMaster;

class UpdateFacultyJobTest extends \Codeception\TestCase\Test
{
    ...
    */
    ...
    /**
     * @var \Synapse\UploadBundle\Job\UpdateFaculty
     */
    ...
    private function createTestUser()
    {
        ...
        $person->setExternalId('CreateFacultyJobTest');
