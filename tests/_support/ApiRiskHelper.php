...
class ApiRiskHelper extends \Codeception\Module
{
    private $output;
    ...
    public function _beforeSuite($settings=[])
    {
        ...
        if(getenv('environment') == 'test') {
            ...
            if($this->output == '') {
                codecept_debug('Saving test data for non-Risk Tests');
            }
            else{
        ...
        $this->output = shell_exec('./managedata.sh --reload risk');
    ...
    public function _afterSuite()
    {
        ...
        if(getenv('environment') == 'test') {
            ...
            if ($this->output == '') {
                codecept_debug('Reloaded test data for non-Risk Tests');
            } else {
