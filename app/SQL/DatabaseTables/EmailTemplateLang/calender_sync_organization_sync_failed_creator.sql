INSERT INTO `synapse`.`email_template` (`email_key`, `from_email_address`, `is_active`) VALUES ('calender_sync_organization_sync_failed_creator', 'no-reply@mapworks.com', '1');

SET @emailtemplateId = (SELECT id from email_template where email_key = 'calender_sync_organization_sync_failed_creator');
