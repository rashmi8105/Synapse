 ...
 */
class Version20151201200059 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE org_talking_points ADD COLUMN org_academic_year_id INT(11) AFTER survey_id;');

        $this->addSql('ALTER TABLE org_talking_points ADD FOREIGN KEY (org_academic_year_id) REFERENCES org_academic_year(id);');

        $this->addSql('ALTER TABLE org_talking_points ADD COLUMN org_academic_terms_id INT(11) AFTER org_academic_year_id;');

        $this->addSql('ALTER TABLE org_talking_points ADD FOREIGN KEY (org_academic_terms_id) REFERENCES org_academic_terms(id);');

        $this->addSql('ALTER TABLE org_talking_points ADD COLUMN source_modified_at DATETIME;');
