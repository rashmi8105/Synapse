 ...
 */
class Version20160307223153 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        /**
         * Changed all SQL Key words to CAPS and moved the student reports flagging portion
         * to before the talking points and Risk flagging portion per ESPRJ-9174
         */
        $this->addSQL('DROP PROCEDURE `Factor_Calc`;');
