 ...
 */
class Version20170130085249 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql("UPDATE ebi_metadata SET deleted_at = NOW() where meta_key = 'RetentionTrack'");
...
left join org_academic_year as oay ON opc.org_academic_year_id = oay.id where opc.organization_id = ',orgId,')
    ...
    distinct
        ...
        IFNULL(opsr.is_enrolled_beginning_year,"") AS EnrolledAtMidpointOfAcademicYear,
        IFNULL(opsr.is_enrolled_midyear,"") AS EnrolledAtBeginningOfAcademicYear,
        IFNULL(opsr.is_degree_completed,1) AS CompletedADegree,
