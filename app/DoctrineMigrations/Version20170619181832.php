...
/**
 * ESPRJ-15221 - Migration Script for change org_person_student_retention_completion_variables_view column name alias
 */
class Version20170619181832 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        // Change org_person_student_retention_completion_variables_view column names alias
        $this->addSql("CREATE OR REPLACE
                        ...
                        VIEW `synapse`.`org_person_student_retention_completion_variables_view` AS
                            select 
                                ...
                                max(`opsrcpv`.`Completed Degree in 1 Year or Less`) AS `Completed Degree in 1 Year or Less`,
                                max(`opsrcpv`.`Completed Degree in 2 Years or Less`) AS `Completed Degree in 2 Years or Less`,
                                max(`opsrcpv`.`Completed Degree in 3 Years or Less`) AS `Completed Degree in 3 Years or Less`,
                                max(`opsrcpv`.`Completed Degree in 4 Years or Less`) AS `Completed Degree in 4 Years or Less`,
                                max(`opsrcpv`.`Completed Degree in 5 Years or Less`) AS `Completed Degree in 5 Years or Less`,
                                max(`opsrcpv`.`Completed Degree in 6 Years or Less`) AS `Completed Degree in 6 Years or Less`
                            from
