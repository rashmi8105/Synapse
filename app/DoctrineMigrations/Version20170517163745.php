...
/**
 * Migration Script to insert mapworks_action_variable table for create referral
 * This migration script is for ESPRJ-13965
 */
class Version20170517163745 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        // Variables for referral_create_current_assignee
        $this->addSql(" SET @mapworksActionIdForAssignee = (SELECT id FROM mapworks_action where event_key ='referral_create_current_assignee')");
        ...
        // Variables for referral_create_interested_party
        $this->addSql(" SET @mapworksActionIdForInterestedParty = (SELECT id FROM mapworks_action where event_key ='referral_create_interested_party')");
        $this->addSql("INSERT INTO mapworks_action_variable (mapworks_action_id, mapworks_action_variable_description_id) 
                            VALUES 
                            (
        ...
        // Variables for referral_create_student
        $this->addSql(" SET @mapworksActionIdForStudent = (SELECT id FROM mapworks_action where event_key ='referral_create_student')");
        $this->addSql("INSERT INTO mapworks_action_variable (mapworks_action_id, mapworks_action_variable_description_id) 
                            VALUES 
                            (
                                (@mapworksActionIdForStudent),
                                (SELECT id FROM mapworks_action_variable_description WHERE variable = '$student_first_name')
                            ),
                            (
                                (@mapworksActionIdForStudent),
                                (SELECT id FROM mapworks_action_variable_description WHERE variable = '$student_dashboard')
                            ),
                            (
                                (@mapworksActionIdForStudent),
                                (SELECT id FROM mapworks_action_variable_description WHERE variable = '$coordinator_first_name')
        ...
        // Variables for referral_create_creator
        $this->addSql(" SET @mapworksActionIdForCreator = (SELECT id FROM mapworks_action where event_key ='referral_create_creator')");
        $this->addSql("INSERT INTO mapworks_action_variable (mapworks_action_id, mapworks_action_variable_description_id) 
                            VALUES 
                            (
