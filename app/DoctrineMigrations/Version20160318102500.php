...
/**
Author: Hai Deng
Function: ESPRJ-9395 for improve the predefined search performance at second level for orgId:128 University of Oklahoma.
 */
 ...
 */
class Version20160318102500 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
...
CDATA;
        ...
        update ebi_search SET `query` = 'SELECT SQL_CALC_FOUND_ROWS
                ...
                GROUP BY P.id'
                WHERE  `query_key` = 'In-progress_Grade_Of_D_Or_Below';";
