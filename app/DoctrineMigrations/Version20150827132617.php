 ...
 */
class Version20150827132617 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE report_tips CHANGE title title VARCHAR(45) DEFAULT NULL');
...
where pfc.person_id = @studentId and pfc.organization_id = @orgId and ft.survey_id = @surveyId and r.name='student-report'
...
CDATA;
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE report_tips CHANGE title title VARCHAR(25) DEFAULT NULL COLLATE utf8_unicode_ci');
