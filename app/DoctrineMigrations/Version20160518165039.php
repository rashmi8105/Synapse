 ...
 */
class Version20160518165039 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    {
        /**
         * This will update the student Data Dump so that it can handle
         * receive survey information and no year metadata values.
         */
...
left join org_academic_year as oay ON opc.org_academic_year_id = oay.id )
    ...
    CROSS JOIN org_academic_year ON org_academic_year.organization_id = ops.organization_id
    ...
    WHERE
        ...
        NULL,
            ...
            org_academic_terms.name,
            ""
    FROM
        org_person_student
    CROSS JOIN org_academic_terms ON org_academic_terms.organization_id = org_person_student.organization_id
