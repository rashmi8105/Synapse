...
/**
 * Migration file to edit the student Datadump to get value for participating column
 */
class Version20161214092024 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
        ...
        $procedure = <<<EOD
            ...
            left join org_academic_year as oay ON opc.org_academic_year_id = oay.id where opc.organization_id = ',orgId,')
                ...
                distinct
                    ...
                    IF(opsy.id, 1, if(innie.year_id != "", "0", "")) AS Participating,
