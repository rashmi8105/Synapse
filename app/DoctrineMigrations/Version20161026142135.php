...
/**
 * Fix for ESPRJ-11987. Added the org_academic_year.deleted_at check into the inner joins as
 * clients are able to delete and recreate academic years
 */
class Version20161026142135 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
