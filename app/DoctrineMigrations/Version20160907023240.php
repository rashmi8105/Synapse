...
/**
 * This migration script re-creates the migration script Version20160217113400 that somehow disappeared from production on March 17.
 */
class Version20160907023240 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
