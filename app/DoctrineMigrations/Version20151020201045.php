 ...
 */
class Version20151020201045 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        BEGIN
            ...
            #--Update the redundant person value for risk score
                ...
                where PRH.risk_score <> (select risk_score from person_risk_level_history pr where pr.person_id = P.id ORDER BY date_captured DESC LIMIT 1, 1) ;
