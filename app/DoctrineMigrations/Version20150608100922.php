 ...
 */
class Version20150608100922 extends AbstractMigration
{
    public function up(Schema $schema)
    {
		...
		UPDATE `synapse`.`email_template_lang` SET `subject`='Course upload finished importing
...
UPDATE `synapse`.`email_template_lang` SET `body`='<html>
  ...
  UPDATE `synapse`.`email_template_lang` SET `subject`='Faculty upload finished importing
' WHERE `email_template_id`=@emtid;
UPDATE `synapse`.`email_template_lang` SET `body`='<html>
  <head>
  <style>body {
