 ...
 */
class Version20160701130100 extends AbstractMigration
{
    /**
     * This migration script is to update table "ebi_template_lang" where key is Pdf_GroupStudent_Header_Template
     * and to add new Pdf_GroupStudent_ExplanatoryNotes_Template
	 * @param Schema $schema
     */
...
CDATA;
        ...
        $this->addSql($query1);
        $this->addSql("INSERT INTO ebi_template VALUES ('Pdf_GroupStudent_ExplanatoryNotes_Template','y')");
        $query2 = <<<CDATA
...
CDATA;
        $this->addSql($query2);
        $this->addSql("INSERT INTO ebi_template VALUES ('Pdf_GroupName_Body_Template','y')");
        ...
        $htmlTemplateString =
            '"'."<div id='outerContainer'>
                ...
                <div class='align1 userInfoDetails'>
                    ...
                    <span class='boldStyler'>$columnName</span></p></div>
                    <br>
                    <div class='columnNameContainer dataTypeContainer'><p><span class='italicStyler'>Data Type:</span>Text</p></div>
                </div>
            </div>".'"';
        $templateCreationQuery = "INSERT INTO ebi_template_lang (ebi_template_key, lang_id, description, body) VALUES ('Pdf_GroupName_Body_Template', @langid, NULL, $htmlTemplateString)";
        $this->addSql($templateCreationQuery);
        $required = '$$required$$';
        $length = '$$length$$';
        ...
        $query3 = <<<CDATA
        UPDATE ebi_template_lang
        SET body = '<div id="outerContainer">
                <div class="align1 subHeadingDiv">
                    <div class="columnNameContainer details"><p class="idHeading">$columnName &nbsp;<span
                ...
                <div class="align1 userInfoDetails">
                    <div class="columnNameContainer columnNameContainer2"><p><span class="italicStyler">Column Name:</span> <span
                            class="boldStyler">$columnName</span></p></div>
                    <br>
                    <div class="columnNameContainer dataTypeContainer"><p><span class="italicStyler">Data Type:</span>Text</p>
                        <p>(Max Length: $length characters)</p></div>
                </div>
                <div class="validvalues align1"><p>$optionalTitle</p>
                    <ul class="valueslist"> $optional</ul>
                </div>
            </div>'
