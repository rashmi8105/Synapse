...
/**
 * ESPRJ-16123 Fixing Missing Cohort JOIN
 */
class Version20170929162538 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE DEFINER=`synapsemaster`@`%` PROCEDURE StudentIssuesCalculation(p_orgid SMALLINT UNSIGNED, p_facultyid INT UNSIGNED, p_orgacademicyearid INT UNSIGNED, p_surveyid SMALLINT UNSIGNED, p_cohortid SMALLINT UNSIGNED)
            DETERMINISTIC
