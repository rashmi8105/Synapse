 ...
 */
class Version20160419092749 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('DROP TABLE IF EXISTS org_group_tree');
		
        $this->addSql('CREATE TABLE org_group_tree 
							(
        ...
        $this->addSql('ALTER TABLE org_group_tree ADD CONSTRAINT FK_1B384A68DE12AB56 FOREIGN KEY (created_by) REFERENCES person (id)');
        $this->addSql('ALTER TABLE org_group_tree ADD CONSTRAINT FK_1B384A6825F94802 FOREIGN KEY (modified_by) REFERENCES person (id)');
        $this->addSql('ALTER TABLE org_group_tree ADD CONSTRAINT FK_1B384A681F6FA0AF FOREIGN KEY (deleted_by) REFERENCES person (id)');
        $this->addSql('ALTER TABLE org_group_tree ADD CONSTRAINT FK_1B384A68582DCD11 FOREIGN KEY (ancestor_group_id) REFERENCES org_group (id)');
        $this->addSql('ALTER TABLE org_group_tree ADD CONSTRAINT FK_1B384A68FCA5FABF FOREIGN KEY (descendant_group_id) REFERENCES org_group (id)');

        //load data into org_group_tree from org_group
        $this->addSql('INSERT INTO org_group_tree(ancestor_group_id, descendant_group_id, path_length, created_at, modified_at, deleted_at) SELECT id, id, 0, created_at, modified_at, deleted_at FROM org_group');
        $this->addSql('INSERT INTO org_group_tree(ancestor_group_id, descendant_group_id, path_length, created_at, modified_at, deleted_at) SELECT og2.id, og1.id, 1, og1.created_at, og1.modified_at, coalesce(og1.deleted_at, og2.deleted_at) FROM org_group og1 JOIN org_group og2 ON og1.parent_group_id = og2.id WHERE og2.id IS NOT NULL');
