...
/**
 * ESPRJ-11589-ESPRJ-11403-ESPRJ-11645 Soft Deletion Changes to Stored Procedure V1 Risk
 */
class Version20171031171917 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql("DROP PROCEDURE IF EXISTS `risk_calculation_V1`;");
        $this->addSql("CREATE DEFINER = `synapsemaster`@`%` PROCEDURE `risk_calculation_V1`(deadline TIMESTAMP, chunksize SMALLINT UNSIGNED)
                                DETERMINISTIC
                            ...
                            BEGIN
                                        ...
                                        #--Update the redundant person value for risk score
                                            UPDATE person P
                                                INNER JOIN person_risk_level_history AS PRH ON P.id = PRH.person_id
