 ...
 */
class Version20150704153010 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->abortIf($this->connection->getDatabasePlatform()
			...
			UPDATE `synapse`.`email_template_lang` SET `subject`=\'Mapworks accounts merged\' WHERE `email_template_id`=@emtid;	
