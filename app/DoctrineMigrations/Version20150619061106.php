 ...
 */
class Version20150619061106 extends AbstractMigration
{
...
(select org_id,person_id,risk_variable_id,risk_model_id,bucket_value,(bucket_value*weight) as calc_weight,SourceValue from cur_org_calculated_risk_variable);
#To fetch org_id
set @cur_org_id := null;
SELECT org_id into @cur_org_id FROM org_riskval_calc_inputs where is_riskval_calc_required = 'y' group by org_id order by org_id limit 1;
