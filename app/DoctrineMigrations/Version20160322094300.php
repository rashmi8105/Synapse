...
/**
Author: Hai Deng
Function: ESPRJ-9426 for the bug of duplicate student person_id. Just add "ignore" when insert into the table listofpeeps
 */
 ...
 */
class Version20160322094300 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
