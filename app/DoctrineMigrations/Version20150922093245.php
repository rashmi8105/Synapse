 ...
 */
class Version20150922093245 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
...
update org_calc_flags_student_reports set calculated_at = now() where person_id=@studentId and org_id = @orgId and survey_id = @surveyId and report_id = @reportId ;
