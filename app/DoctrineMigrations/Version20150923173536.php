 ...
 */
class Version20150923173536 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSQL("CREATE PROCEDURE org_RiskFactorCalculation(deadline TIMESTAMP, chunksize SMALLINT UNSIGNED)
        DETERMINISTIC
    ...
    $this->addSQL('DROP PROCEDURE IF EXISTS fix_datum_src_ts;');

    $this->addSQL('CREATE PROCEDURE fix_datum_src_ts()
        DETERMINISTIC
        SQL SECURITY INVOKER
        BEGIN
