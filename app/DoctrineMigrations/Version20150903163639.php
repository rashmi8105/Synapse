 ...
 */
class Version20150903163639 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        select svr.org_id,svr.person_id,fq.factor_id, svr.survey_id, avg(svr.decimal_value) as mean_value, timeVar, timeVar
        ...
        WHERE factor_id IS NOT NULL AND ofc.calculated_at IS NULL AND FLOOR(svr.decimal_value) != 99
        ...
        //Fixing Small Syntax error with org_id on Talking Points
        ...
        update org_calc_flags_talking_point orf LEFT JOIN org_talking_points as tp ON tp.organization_id = orf.org_id AND tp.person_id = orf.person_id set orf.calculated_at = '1900-01-01 00:00:00', orf.modified_at = timeVar WHERE tp.modified_at != timeVar;
        ...
        BEGIN
            ...
            update org_calc_flags_success_marker orc LEFT JOIN success_marker_calculated as smc ON smc.organization_id = orc.org_id AND smc.person_id = orc.person_id set orc.calculated_at = '1900-01-01 00:00:00', orc.modified_at = timeVar WHERE smc.modified_at != timeVar;
