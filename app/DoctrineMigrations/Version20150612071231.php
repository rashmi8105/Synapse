 ...
 */
class Version20150612071231 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->abortIf($this->connection->getDatabasePlatform()
            ->getName() != 'mysql', 'Migration can only be executed safey on \'mysql\'.');
...
UPDATE `email_template_lang` SET `body`='<o:AllowPNG/>
