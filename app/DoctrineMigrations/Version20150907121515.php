 ...
 */
class Version20150907121515 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $this->addSql('SET @deneychangereq := (SELECT id FROM email_template where email_key="Deny_Change_Request");
 ...
 *[class=openhtml] { padding: 10px !important; }
...
</html>\'  WHERE `email_template_id`=@deneychangereq;"
            ');
        
        $this->addSql('SET @actemail := (SELECT id FROM email_template where email_key="Activate_Email");
 ...
 <![endif]-->
 <title>Mapworks accounts merged</title>
 <meta name="viewport" content="width=device-width, initial-scale=1.0">
 <meta http-equiv="X-UA-Compatible" content="IE=edge" />
 <style type="text/css">
 /* e-mail bugfixes */
 ...
 *[class=openhtml] { padding: 10px !important; }
 						...
 						<tr>
 						  ...
 						  <table width="100%" cellpadding="0" cellspacing="0" border="0">
 							  <tbody>
 								<tr>
 								  <td style="font-family: helvetica neue, helvetica, arial, verdana, san-serif; font-size: 14px; color: #262727; line-height:18px;" align="left" valign="top">
 										<a href=\"\$\$activation_token\$\$\" target=\"_blank\">\$\$activation_token\$\$</a>
 								  </td>
 								</tr>
 							  </tbody>
 							</table>
 						  ...
 						  <table width="100%" cellpadding="0" cellspacing="0" border="0">
 							  <tbody>
 								<tr>
 								  <td style="font-family: helvetica neue, helvetica, arial, verdana, san-serif; font-size: 14px; color: #262727; line-height:18px;" align="left" valign="top">
 									Thank you.</br>
 								<img src = \"\$\$Skyfactor_Mapworks_logo\$\$\" alt = \"Skyfactor Mapworks logo\" title = \"Skyfactor Mapworks logo\" /> <br/>
 ...
 </body></html>\'  WHERE `email_template_id`=@actemail;');
        
        
        $this->addSql('SET @deactemail := (SELECT id FROM email_template where email_key="Deactivate_Email");
...
</html>\'  WHERE `email_template_id`=@deactemail;');
    }
