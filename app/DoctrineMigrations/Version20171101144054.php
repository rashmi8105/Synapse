...
/**
 * ESPRJ-16263 Updating Factor Calculation to eliminate Risk Queue Bug
 */
class Version20171101144054 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
        ...
        $this->addSql("CREATE DEFINER=`synapsemaster`@`%` PROCEDURE `Factor_Calc`(deadline TIMESTAMP, chunksize SMALLINT UNSIGNED)
                            BEGIN
                                    ...
                                    DO
                                        ...
                                        -- marking all unsuccesful flags to have the 1900 flag for calculated and not valid, purposefully not checking soft deletion
                                        UPDATE 
                                            org_calc_flags_factor ocff
                                        SET 
