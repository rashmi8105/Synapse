...
/**
 * ESPRJ-17688; Updated student_data_dump to use sequence instead of id
 */
class Version20180411184107 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    WHERE
        ...
        meta_key,
            (SELECT
                    MAX(sort_order)
                FROM
                    upload_ebi_metadata_column_header_download_map) + sequence + 1,
            2
    FROM
        org_metadata om
    WHERE
