 ...
 */
class Version20150812152433 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    ...
    #--Risk level matching:
        #--For levels specified by ranges
            LEFT JOIN risk_variable_range rvr
                ...
                AND RV.calculated_value BETWEEN rvr.min AND rvr.max
...
VIEW person_risk_level_calc AS 
    ...
    $this->addSQL($redoViewsForCalculationDates);
