...
/**
 * AcademicUpdateRequestFaculty
 *
 * @ORM\Table(name="academic_update_request_faculty", indexes={@ORM\Index(name="fk_academic_update_request_faculty_person1_idx", columns={"person_id"}), @ORM\Index(name="fk_academic_update_request_faculty_organization1_idx", columns={"org_id"}), @ORM\Index(name="fk_academic_update_request_faculty_academic_update_request1_idx", columns={"academic_update_request_id"})})
 * @ORM\Entity
 */
class AcademicUpdateRequestFaculty
{
    ...
    /**
     *
     * @var \Person @ORM\OneToOne(targetEntity="Synapse\CoreBundle\Entity\Person")
     *      @ORM\JoinColumns({
     ...
     * Set person
     *
     * @param \Synapse\AcademicUpdateBundle\Entity\Person $person            
     * @return AcademicUpdateRequestFaculty
     */
