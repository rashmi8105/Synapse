...
use Synapse\UploadBundle\Command\GroupStudentUploadCommand;

class ProcessGroupStudentUpload extends ContainerAwareJob
{
    public function run($args)
    {
        $command = new GroupStudentUploadCommand();
