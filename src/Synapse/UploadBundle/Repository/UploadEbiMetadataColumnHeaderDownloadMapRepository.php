...
use Synapse\UploadBundle\Entity\UploadEbiMetadataColumnHeaderDownloadMap;

class UploadEbiMetadataColumnHeaderDownloadMapRepository extends SynapseRepository
{

    const REPOSITORY_KEY = 'SynapseUploadBundle:UploadEbiMetadataColumnHeaderDownloadMap';
