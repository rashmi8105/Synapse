...
use Synapse\UploadBundle\Entity\UploadColumnHeader;


class UploadColumnHeaderRepository extends SynapseRepository
{

    const REPOSITORY_KEY = 'SynapseUploadBundle:UploadColumnHeader';
     ...
     *
     * @return null | UploadColumnHeader
     * @throws  \Exception
     */
