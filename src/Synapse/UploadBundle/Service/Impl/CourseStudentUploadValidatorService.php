 ...
 *
 * @DI\Service("course_student_upload_validator_service")
 */
class CourseStudentUploadValidatorService extends AbstractService implements UploadValidatorServiceInterface
{

    const SERVICE_KEY = 'course_student_upload_validator_service';
    ...
    public function validate($name, $data, $orgId, $isUpdate = false)
    {
        ...
        if (strtolower($name) != strtolower(UploadConstant::UNIQUECOURSESECTIONID)) {
