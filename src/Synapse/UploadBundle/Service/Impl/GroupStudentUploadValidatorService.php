...
*
* @DI\Service("group_student_upload_validator_service")
*/
class GroupStudentUploadValidatorService extends AbstractService implements UploadValidatorServiceInterface
{

    const SERVICE_KEY = 'group_student_upload_validator_service';
